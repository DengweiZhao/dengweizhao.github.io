...
<ul>
  ...
  <li>
    ...
    <em>"SeeA*: Efficient Exploration-Enhanced A* Search by Selective Sampling. Advances in Neural Information Processing Systems (NeurIPS 2024, <span style="color:red;">Oral</span> paper, 61/15671≈0.39%, CCF-A）"</em>.
    ...
    <a href="https://github.com/CMACH508/SEEA_star">[code]</a>
  </li>
  <li>
    <strong>Dengwei Zhao</strong>, Shikui Tu*, Lei Xu*.
  ...
  <li>
    <strong>Dengwei Zhao</strong>, Shikui Tu*, Lei Xu*.
    <em>"Generalized Weighted Path Consistency for Mastering Atari Games. Advances in Neural Information Processing Systems (NeurIPS 2023, CCF-A）"</em>.
    <a href="https://proceedings.neurips.cc/paper_files/paper/2023/file/9d87a0c38431d0ec8d8b8ece95198c04-Paper-Conference.pdf">[paper]</a>
  ...
  <li>
    <strong>Dengwei Zhao</strong>, Shikui Tu*, Lei Xu*.
    <em>"Efficient Learning for AlphaZero via Path Consistency. International Conference on Machine Learning (ICML 2022, CCF-A）"</em>.
    <a href="https://proceedings.mlr.press/v162/zhao22h.html">[paper]</a>
    <a href="https://github.com/CMACH508/DeepTH">[code]</a>
  </li>
</ul>
...
<ul>
  <li>
    Jingyuan Zhou, <strong>Dengwei Zhao</strong>, et al.
    <em>"Multi-Objective Structure-Based Drug Design Using Causal Discovery. IEEE/ACM Transactions on Computational Biology and Bioinformatics (TCBB 2025, CCF-B)"</em>.
    <a href="https://ieeexplore.ieee.org/document/11008440">[paper]</a>
    <a href="https://github.com/CMACH508/MoC">[code]</a>
  </li>
  <li>
    <strong>Dengwei Zhao</strong>, Shikui Tu*, Yanan Sun, Lei Xu*.
    <em>"Efficient Retrosynthetic Planning with MCTS Exploration Enhanced A*. Communications Chemistry 2024 (中科院Q1 Top, JCR Q1)"</em>.
    <a href="https://www.nature.com/articles/s42004-024-01133-2">[paper]</a>
    <a href="https://github.com/CMACH508/MEEA">[code]</a>
  </li>
  <li>
    <strong>Dengwei Zhao</strong>, Jingyuan Zhou, Shikui Tu*, Yanan Sun, Lei Xu*.
    <em>"De Novo Drug Design by Multi-Objective Path Consistency Learning with Beam A* Search. IEEE/ACM Transactions on Computational Biology and Bioinformatics (TCBB 2024, CCF-B)"</em>.
    <a href="https://ieeexplore.ieee.org/document/10713175">[paper]</a>
    <a href="https://github.com/CMACH508/DrugBA_star">[code]</a>
  </li>
  <li>
    Hao Qian, Cheng Lin, <strong>Dengwei Zhao</strong>, et al.
    <em>"AlphaDrug: protein target specific de novo molecular generation. PNAS Nexus"</em>.
    <a href="https://academic.oup.com/pnasnexus/article/1/4/pgac227/6751929?login=false">[paper]</a>
    <a href="https://github.com/CMACH508/AlphaDrug">[code]</a>
  </li>
